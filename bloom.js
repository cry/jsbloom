...
JSBloom.filter = function(items, target_prob) {
    ...
    exportImportInit = function(encode, decode) {
        if (!(typeof encode == 'function' && typeof decode == 'function')) throw Error('Encode and decode must be functions.');

        // Override old functions with new.
